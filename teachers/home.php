...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		...
		<div class="navbar-nav ml-auto">
			...
			<div class="nav-item dropdown">
				<a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle user-action"><img src="/examples/images/avatar/2.jpg" class="avatar" alt="Avatar"><?php echo $_SESSION['name']; ?><b class="caret"></b></a>
				<div class="dropdown-menu">
					<a href="/SCHOOL/teachers/profile.php" class="dropdown-item"><i class="fa fa-user-o"></i> Profile</a></a>
